...
export default function Navbar() {
    ...
    return (
        <div className='bg-gray-950  w-full flex mb-10 items-center group justify-center gap-10  px-32 py-6'>
            <Image onClick={handleReload} className=" scale-150  group-hover:scale-105 lg:scale-100  transition-all cursor-pointer" alt="logo" src="/logo.png" width={200} height={200}/>
